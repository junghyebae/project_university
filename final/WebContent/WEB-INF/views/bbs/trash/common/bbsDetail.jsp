	...
	<div id="postlist">        
        <div class="panel">
            ...
            <div class="panel-footer">
                <span class="label label-default"><a href="./update.do?seq=${bbs.bbsSeq }">수정</a></span> 
                <span class="label label-default"><a href="./delete.do?seq=${bbs.bbsSeq }&page=${param.page}">삭제</a></span>
            </div>
            </c:if>
        </div>
    </div>