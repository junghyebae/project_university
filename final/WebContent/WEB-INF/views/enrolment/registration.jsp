		...
		<div class="table-responsive">
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<td><input type="text" size="50" id="sub_name" name="sub_name">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select name="sub_semester" id="sub_semester">
							<option value="1">1</option>
							<option value="2">2</option>
					</select></td>
				</tr>
				<tr>
					...
					<td><select name="sub_week" id="sub_week">
               ...
               <%=i %>
                  ...
                  %>
					...
					</select> ~ <select id="sub_e_class" name="sub_e_class">
							<%
                  for(int i = 1; i <= 10; i++){
                     %>
							<option id="EclsOpt<%=i %>"
               ...
               <%=i %>
				...
				<tr>
					...
					<td><select name="sub_max_student" id="sub_max_student">
				...
				<tr>
					...
					<td><select name="sub_point" id="sub_point">
							<option value="2">2</option>
							<option value="3">3</option>
					</select></td>
				</tr>
				<tr>
					...
					<td><input type="text" size="50" id="sub_room" name="sub_room">
					</td>
				</tr>
				<tr>
					<th class="text-center">강의소개</th>
					<td><textarea rows="10" cols="40" id="sub_info"
							name="sub_info"></textarea></td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" size="30" id="addBtn" class="btn btn-info"
						name="addBtn" value="등록"> <input type="reset" class="btn btn-danger" value="취소">
					</td>
				</tr>
			</table>
		</div>
