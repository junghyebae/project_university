...
<!-- 글 수정시 -->
<form action="./introBbsUpdateAf.do" method="POST" enctype="multipart/form-data">
<input type="hidden" name="intro_bbs_seq" value="${dto.intro_bbs_seq }" /> 
<input type="hidden" name="filename" value="${dto.filename }" /> 
<input type="hidden" name="org_filename" value="${dto.org_filename }" /> 
    <div class="col-md-9">
	...
	<div class="form-group"> <!-- content field -->
		...
		<textarea class="form-control" cols="40" id="content" name="content" rows="10">${dto.content }</textarea>
	</div>
